            ...
            <div className="a-education-timeline  c-timeline  t-border-color  o-section__full-top-space">
                ...
                <div className="o-content">
                  <div className="o-grid">
                    <div className="o-grid__col-md-5">
                      <div className="c-work__timeframe">2008 &ndash; 2010</div>
                      ...
                      <div className="c-work__location">Miami, FL</div>
                    </div>
              ...
              <div className="c-timeline__item">
                ...
                <div className="o-content">
                  <div className="o-grid">
                    <div className="o-grid__col-md-5">
                      <div className="c-work__timeframe">2003 &ndash; 2008</div>
                      <h3 className="c-work__heading">Ninsei University</h3>
                      <h4 className="c-work__title">
                        Bachelor of Computer Science
                      </h4>
                      <div className="c-work__location">Tokyo, Japan</div>
                    </div>
                    <div className="o-grid__col-md-7">
                      <p>
                        Lorem ipsum dolor sit amet, consectetuer adipiscing
                        elit. Phasellus hendrerit. Pellentesque aaliquet nibh
                        nec urna. In nisi neque, aliquet vel, dapibus id, mattis
              ...
              <div className="c-timeline__item">
                ...
                <div className="o-content">
                  <div className="o-grid">
                    <div className="o-grid__col-md-5">
                      <div className="c-work__timeframe">2000 &ndash; 2003</div>
                      <h3 className="c-work__heading">Academy of Fine Arts</h3>
                      <h4 className="c-work__title">Master of Arts</h4>
                      <div className="c-work__location">Berlin, Germany</div>
                    </div>
                    <div className="o-grid__col-md-7">
                      <p>
                        Fusce lacinia arcu et nulla. Nulla vitae mauris non
                        felis mollis faucibus. Phasellus hendrerit. Pellentesque
