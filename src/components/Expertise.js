        ...
        <div className="o-section__content  t-section__content  ">
          <div className="o-grid">
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">01</div>
                </div>
            ...
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">02</div>
                </div>
                <div className="o-media__body  o-content__body">
                  <h3>Front-end Design</h3>
                  <p>
                    Sed adipiscing ornare risus. Morbi est est, blandit sit
            ...
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">03</div>
                </div>
                <div className="o-media__body  o-content__body">
                  <h3>Ruby on Rails</h3>
                  <p>
            ...
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">04</div>
                </div>
                <div className="o-media__body  o-content__body">
                  <h3>Object-oriented PHP</h3>
                  <p>
                    Morbi in sem quis dui placerat ornare. Ut aliquam
            ...
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">05</div>
                </div>
                <div className="o-media__body  o-content__body">
                  <h3>WordPress</h3>
                  <p>
                    Phasellus ultrices nulla quis nibh. Fusce lobortis lorem.
            ...
            <div className="o-grid__col-sm-6">
              <div className="o-media  o-media--block  o-content">
                <div className="o-media__figure">
                  <div className="c-number  t-primary-color">06</div>
                </div>
                <div className="o-media__body  o-content__body">
